"""
It's an UI pattern to separate internal representations of data from ways it is presented
to/from user.
"""
...
class View(ABC):
    ...
    @abstractmethod
    def show_item_information(self, item_type: str, item_name: str, item_info: Dict[str, Any]) -> None:
...
if __name__ == "__main__":
    ...
    controller.show_item_information("bread")
